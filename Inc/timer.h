...
/****************************************************************************/
/**  tim_reg_base Timer register base addresses
*/
...
void timer_enable_irq(uint32_t timer_peripheral, uint32_t irq); //this is need to set the update event interrupt
void timer_disable_irq(uint32_t timer_peripheral, uint32_t irq);
bool timer_interrupt_source(uint32_t timer_peripheral, uint32_t flag); // Requited to tell if the interrupt is hit/ enabled
bool timer_get_flag(uint32_t timer_peripheral, uint32_t flag);
void timer_clear_flag(uint32_t timer_peripheral, uint32_t flag); // use to clear the interrupt once it is hit
